...
const Footer = () => {
  const socialLinks = [
    { name: 'GitHub', url: 'https://github.com/VarshanMaj1' },
    { name: 'LinkedIn', url: 'https://www.linkedin.com/in/varshan-maji-6a67812b0/' },
  ];
      ...
      <div className="relative z-10 mx-auto max-w-7xl px-4 py-20">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
          ...
          <div className="space-y-4">
            <h3 className="text-2xl font-bold text-white">Varshan Maji</h3>
        ...
        <div className="mt-16 pt-8 border-t border-neutral-800">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            <p className="text-neutral-400 text-sm">
              © 2024 Varshan. All rights reserved.
            </p>
